...
public class SlimeOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("test:slime_ore", FEATURE,
				new OreConfiguration(SlimeOreFeatureRuleTest.INSTANCE, TestModBlocks.SLIME_ORE.get().defaultBlockState(), 9));
		PLACED_FEATURE = PlacementUtils.register("test:slime_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(15), InSquarePlacement.spread(),
	...
	private static class SlimeOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("test:slime_ore_match"), CUSTOM_MATCH);
		}
